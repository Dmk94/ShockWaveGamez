    ...
    if(!empty($txn_id)){ 
        ...
        if($prevPayment->num_rows > 0){ 
            ...
            if($insertOrder){ 
                ...
                $insertPayment = $db->query("INSERT INTO payments(orders_id,payer_name,payer_email,txn_id,payment_gross,currency_code,payment_status) VALUES($order_id,'".$payer_name."','".$payer_email."','".$txn_id."','".$payment_gross."','".$currency_code."','".$payment_status."')"); 
